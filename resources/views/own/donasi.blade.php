			...
			<div class="card-body p-4">
				<div class="d-flex justify-content-between">
					<div class="d-flex align-items-center">
						<h5 class="card-title h2">Donasi</h5>
					</div>
				</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Update Donasi</h5>
                ...
                <form id="submitFormUpdate">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tanggal_donasi" id="update-tanggal">
                        </div>
                        <div class="mb-3">
                            <label>Nama Penerima</label>
                            <input type="text" class="form-control" name="nama_penerima" id="update-penerima">
                        </div>
                        <div class="mb-3">
							<label>Status Donasi</label>
							<input type="text" class="form-control" name="status_donasi" id="update-status">
						</div>
                    </div>
    ...
    <div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="modalDeleteLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah kamu yakin ingin menghapus donasi ini?</p>
...
<script>
	...
	function fetchData(page = 1, itemsPerPage = perPage) {
		...
		axios.get(`/api/donasi?page=${page}&per_page=${itemsPerPage}&search=${encodeURIComponent(search)}`, {
	...
	document.addEventListener('click', function(e) {
        if (e.target.classList.contains('update-btn')) {
            ...
            document.getElementById('update-penerima').value = cells[3].textContent;
            document.getElementById('update-status').value = cells[4].textContent;
        }
    ...
    document.getElementById('submitFormUpdate').addEventListener('submit', function(e) {
        ...
        axios.post(`/api/donasi/${id}`, formData, {
            headers: {
