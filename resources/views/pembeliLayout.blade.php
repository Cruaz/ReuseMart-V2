				...
				<div>
					<div class="card" style="width: 20rem;">
						<div class="card-body px-5 py-3">
							<a href="{{ url('/homePembeli') }}" class="w-100 shadow px-5 py-2 btn border-info text-black">
								← Back to Home
							</a>
							<a href="{{url('profilePembeli')}}" class=" w-100 shadow mt-2 px-5  py-2 btn  {{ (request()->is('profilePembeli')) ? 'btn-info text-white border-white' : '  border-info text-black' }}">
								Profile
							</a>
						</div>
					</div>
