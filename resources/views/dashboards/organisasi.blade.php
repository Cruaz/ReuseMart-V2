...
<div class="">
			...
			<div class="card-body p-4">
				<div class="d-flex justify-content-between">
					<div class="d-flex align-items-center">
						<h5 class="card-title h2">Organisasi</h5>
					</div>
			...
			<div class="modal-content">
				...
				<form id="submitFormInsert">
					...
					<div class="modal-body">
						...
						<div class="mb-3">
							<label>Alamat</label>
							<textarea class="form-control" name="alamat_organisasi"></textarea>
						</div>
					</div>
    ...
    <div class="modal fade" id="modalUpdate" tabindex="-1" aria-labelledby="modalUpdateLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Update Organisasi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form id="submitFormUpdate">
                    @csrf
                    <input type="hidden" name="id_organisasi" id="update-id">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label>Username</label>
                        ...
                        <div class="mb-3">
                            <label>Alamat</label>
                            <textarea class="form-control" name="alamat_organisasi" id="update-alamat"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="modalDeleteLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah kamu yakin ingin menghapus organisasi ini?</p>
	...
	<div class="modal fade" id="modalConfirmUpdate" tabindex="-1" aria-labelledby="modalConfirmUpdateLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Apakah datanya sudah benar?</p>
				</div>
				<div class="modal-footer">
					<button class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
					<button class="btn btn-success" id="confirmUpdate">Ya, Simpan</button>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function fetchData(page = 1, itemsPerPage = perPage) {
		...
		axios.get(`/api/organisasi?page=${page}&per_page=${itemsPerPage}&search=${encodeURIComponent(search)}`, {
	...
	document.getElementById('submitFormInsert').addEventListener('submit', function(e) {
		...
		axios.post('/api/organisasi', formData, {
			headers: {
    ...
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('update-btn')) {
            ...
            document.getElementById('update-alamat').value = cells[4].textContent;
        }
	...
	document.getElementById('confirmUpdate').addEventListener('click', function() {
		...
		axios.post(`/api/organisasi/${id}`, formUpdateData, {
			headers: {
				'Authorization': `Bearer ${token}`,
				'Content-Type': 'multipart/form-data'
			}
			...
			fetchData();
			const modalConfirm = bootstrap.Modal.getInstance(document.getElementById('modalConfirmUpdate'));
			modalConfirm.hide();
    ...
    document.getElementById('confirmDelete').addEventListener('click', function() {
        ...
        axios.delete(`/api/organisasi/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        }).then(response => {
